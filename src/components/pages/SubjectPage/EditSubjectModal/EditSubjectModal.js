...
export default function EditSubjectModal({ editSubject }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.values(subjectData).every((item) => item !== "")) {
            api.post(`/subject/${editSubject._id}`, {
                data: {
                    ...subjectData,
                    userID,
                },
                ...
                .then((res) => {
                    ...
                    handleAlertOpen("Subject Updated", "success");
                })
                .catch((err) => {
                    handleAlertOpen("Subject not Updated", "error");
                    console.error(err);
                });
        } else {
